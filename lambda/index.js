...
const dayonejson = require('./documents/dayoneintent.json');
...
//DayOnePicture
const DayOneRequestHandler = {
    canHandle(handlerInput) {
        return (Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
         && Alexa.getIntentName(handlerInput.requestEnvelope) === 'DayOneIntent');
    },
    handle(handlerInput) {
       ...
       // const prompt = data["QUESTION"];
        let speakOutput = "Day One, is a 159 m office building in the Denny Triangle neighborhood of Seattle, Washington, located at the intersection of Lenora Street and 7th Avenue. It is part of the three-tower complex that serves as the headquarters of Amazon. Do you want to see the lobby of this building or visit another building?"
        ...
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
                ...
                handlerInput.responseBuilder.addDirective({
                    ...
                    datasources: {
                        text: {
                            "start": "Welcome to Day One Building " 
                        },
                        images: {
                            "cityPic":"https://elasticbeanstalk-us-east-1-754237753286.s3.amazonaws.com/architectural-design-architecture-building-business-443383.jpg",
...
//DayOnePicture
const LobbyRequestHandler = {
    canHandle(handlerInput) {
        return (Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
         && Alexa.getIntentName(handlerInput.requestEnvelope) === 'LobbyIntent');
    },
    handle(handlerInput) {
        //const data = getLocalizedData(handlerInput.requestEnvelope.request.locale);
        //debug--Logs : Amazon CloudWatch
        ...
        //let speakOutput = " ";
       // const prompt = data["QUESTION"];
        let speakOutput = "Here is the lobby! Do you want to go to second floor, or turn left in the building or visit another building?"
        ...
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
                ...
                handlerInput.responseBuilder.addDirective({
                    ...
                    datasources: {
                        text: {
                            "start": "Welcome to the Lobby of Day One " 
                        },
                        images: {
                            "cityPic":"https://elasticbeanstalk-us-east-1-754237753286.s3.amazonaws.com/Dayonelobby.jpg",
                            "backgroundURL": "https://d2o906d8ln7ui1.cloudfront.net/images/BT7_Background.png",
                            "logoUrl": "https://d2o906d8ln7ui1.cloudfront.net/images/cheeseskillicon.png"
                        }
                    }
