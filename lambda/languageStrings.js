...
module.exports = {
    en: {
        translation: {
            RECIPES: recipes.en,
            SKILL_NAME: `Day One Visitor`,
            HEADER_TITLE: `Welcome to {{skillName}}`,
            RECIPE_HEADER_TITLE: ` {{sauce}} `,
            HELP_HEADER_TITLE: `HELP`,
            HELP_HEADER_SUBTITLE: ``,
            WELCOME_MESSAGE: `Welcome to {{skillName}}! Do you want to go for an Amazon building tour? leave notes on the message wall? or ask a private question to Amazon?`,
            WELCOME_REPROMPT: `For instructions on what you can say, please say help me. `,
            DISPLAY_CARD_TITLE: `{{skillName}} `,
            HELP_MESSAGE: `Do you want to go for an Amazon building tour? leave notes on the message wall? or ask a private question to Amazon?`,
            HELP_REPROMPT: `Do you want to go for an Amazon building tour? leave notes on the message wall? or ask a private question to Amazon?`,
            STOP_MESSAGE: `Goodbye!`,
            RECIPE_REPEAT_MESSAGE: `Try saying repeat.`,
            RECIPE_NOT_FOUND_WITH_ITEM_NAME: `I'm sorry, I currently do not know. what do you want to do ?`,
            RECIPE_NOT_FOUND_WITHOUT_ITEM_NAME: `I'm sorry, I currently do not know. what do you want to do ?`,
